      ...
      <div className="mt-6">
        ...
        {!story.completed && (
          <form onSubmit={handleAddContribution} className="mt-6">
            <div className="mb-4">
              <label className="block text-sm font-bold mb-2" htmlFor="contribution">Add your contribution</label>
              <textarea
                id="contribution"
            ...
            <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded">Add Contribution</button>
          </form>
        )}
      </div>
    </div>
